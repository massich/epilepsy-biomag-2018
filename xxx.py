# This is a draft file to start playing with it, and get a sense of how the pipeline should be

import mne
from mne.datasets import sample

# the raw file containing the channel location + types
raw_fname = '/home/sik/retreat/Biomag2018/original_data/226'
# The paths to freesurfer reconstructions
subjects_dir = '/home/sik/retreat/Biomag2018/freesurfer/'
subject = '226'

## XXXX: I've no idea with this
# mne.set_config() #bla bla
mne.get_config()

def create_source_space(subject=None, spacing='oct6'):
    if subject is None:
        raise RuntimeError('subject is a required parameter')

    name = '{}-{}-src.fif'.format(subject, spacing)
